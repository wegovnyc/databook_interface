<?php
	...
	$name		= 'Anonymus User';				// Nickname when one isn't given
	...
	$icon_size	= '48';						// Size of Gravatar icons in pixels
	$indention	= 'left';					// Side to add comment indention on
	$rows		= '2';						// Default comment box height in rows
	$popular	= '40000000';						// Minimum likes a comment needs to be popular
	$top_cmts	= '0';						// Number of comments allowed to become popular
