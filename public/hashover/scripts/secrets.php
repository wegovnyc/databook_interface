<?php
	...
	$encryption_key		= '8wfwf;lkj98CharKey';			// Unique 8 to 32 character encryption key
	$notification_email	= 'devinbalkind+nycvs@gmail.com';	// E-mail for notification of new comments
	$admin_nickname		= 'databook_admin';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'databook_admin_pwd';			// Password to gain admin rights
