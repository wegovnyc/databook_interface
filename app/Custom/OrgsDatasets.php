...
For a list of all datasets that were included on all the NYC Open Data plans (2013-2020) and their current release status, please refer to NYC Open Data Release Tracker.',
		...
		'crol' => [
			...
			'table' => 'crol',
			'hdrs' => ['Request ID', 'Type Of Notice Description', 'Category Description', 'Short Title', 'Selection Method Description', 'Section Name', 'Due Date'],
			'visible' => [true, true, true, true, true, true, true],
			'flds' => ['"RequestID"', '"TypeOfNoticeDescription"', '"CategoryDescription"', '"ShortTitle"', '"SelectionMethodDescription"', '"SectionName"', '"DueDate"'],
