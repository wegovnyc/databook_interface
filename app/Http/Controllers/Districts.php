...
class Districts extends Controller
{
    ...
    public function main($type=null, $id=null, $section=null)
    {
        ...
        return view('districts', [
					...
					'cdAgencyUrl' => $model->url('SELECT "id", "url" FROM wegov_orgs WHERE "communityDistrictId" LIKE \'%"@@@"%\''),
					'ccAgencyUrl' => $model->url('SELECT "id", "url" FROM wegov_orgs WHERE "cityCouncilDistrictId" LIKE \'%"@@@"%\''),
				]);
    }
